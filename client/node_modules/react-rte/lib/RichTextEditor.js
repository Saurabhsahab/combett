  ...
  _createClass(RichTextEditor, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          otherProps = _objectWithoutProperties(_props, ['value', 'className', 'toolbarClassName', 'editorClassName', 'placeholder', 'customStyleMap', 'readOnly', 'toolbarHidden', 'disabled', 'toolbarConfig', 'toolbarOnBottom', 'blockStyleFn', 'customControls', 'keyBindingFn', 'rootStyle', 'toolbarStyle', 'editorStyle']);
...
export { EditorValue, decorator, createEmptyValue, createValueFromString, getTextAlignBlockMetadata, getTextAlignClassName, getTextAlignStyles, ButtonGroup, Button, Dropdown };