  ...
  _createClass(IconButton, [{
    ...
    value: function render() {
      ...
      var className = props.className,
          ...
          otherProps = _objectWithoutProperties(props, ['className', 'iconName', 'label', 'children', 'isActive', 'isSwitch']);
      ...
      return React.createElement(
        ...
        React.createElement(
          Button,
          _extends({}, otherProps, { title: label, className: className, role: isSwitch && 'switch', 'aria-checked': isActive }),
